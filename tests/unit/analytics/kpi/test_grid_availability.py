"""Unit tests for EOIP Grid Availability KPI."""
...
class TestGridAvailability:
    """Tests for Grid Availability calculation."""

    def test_calculates_full_availability(self) -> None:
        result = calculate_grid_availability(
            grid_available=[
                True,
                True,
                True,
        ...
        assert result.unit == "%"
        assert result.name == "Grid Availability"
    ...
    def test_returns_insufficient_data_for_empty_input(self) -> None:
        ...
        assert result.message == (
            "No valid grid availability observations are available."
        )
    ...
    def test_rejects_non_boolean_observations(
        ...
        assert result.value is None
        assert result.message == ("Grid availability observations must be boolean.")
